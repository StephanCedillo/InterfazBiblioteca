...
public class BusquedaPrestamo {
    ...
    private Button botonEnviar = new Button("Buscar Préstamo");

    public BusquedaPrestamo() {
        generarPanel();
    ...
    public void generarPanel(){
        Label titulo = new Label("BUSQUEDA DE PRESTAMOS", Label.CENTER);
        titulo.setFont(new Font("Serif", Font.PLAIN, 36));

        Panel panelInputs = new Panel(new GridLayout(3, 1, 0, 5));
        InputBusqueda busqueda1 = new InputBusqueda(new Label("Id"));
        InputBusqueda busqueda2 = new InputBusqueda(new Label("ISBN"));
        InputBusqueda busqueda3 = new InputBusqueda(new Label("Cedula"));
        panelInputs.add(busqueda1.getPanelInput());
        panelInputs.add(busqueda2.getPanelInput());
        panelInputs.add(busqueda3.getPanelInput());
